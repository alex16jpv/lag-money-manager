...
const bogota: Scenario = {
  ...
  transactions: [
    ...
    },
    {
      ...
      type: "INCOME",
      amount: 45_000,
      date: "2026-08-27T09:15:00-05:00",
      quick: true,
      note: "A quick income: it reaches the default account, and the tray sums it apart from the expenses.",
    },
    {
      key: "quick-to-savings",
      type: "TRANSFER",
      amount: 100_000,
      date: "2026-08-29T08:00:00-05:00",
      to: "savings",
      quick: true,
      note: "A transfer whose follow-up failed: it waits for review, counts in the tray, and is in neither of its sums.",
    },
  ],
  budgets: [
    {
