...
| `INCOME_ON_CARD_OR_LOAN`          | 400    | An income landing on a CARD or a LOAN: money arriving there is a payment, not income (an OVERDRAFT takes income: its positive balance is its ordinary state) |
