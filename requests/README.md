...
| `invitations.http` | Invitar a un grupo por el email de un contacto, la misma respuesta haya o no cuenta, aceptar y rechazar como el invitado, el grupo como lo ve quien entró (`/joined-groups`), `SHARED_LINE_NOT_PAID`, salir del grupo, dejar de compartir, `CONTACT_HAS_NO_EMAIL`, `INVITATION_UNAVAILABLE` |
